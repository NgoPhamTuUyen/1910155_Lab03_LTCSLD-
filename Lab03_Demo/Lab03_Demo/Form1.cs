...
namespace Lab03_Demo
{
    public partial class frmSinhVien : Form
    {
        ...
        private void lvSinhVien_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ThietLapThongTin((SinhVien)sinhVien);
        }

        private object GetSinhVienOnListViewItem(ListViewItem listViewItem)
        {
        ...
        private void menuItemSearch_Click_1(object sender, EventArgs e)
        {
            var formTuyChon = new frmTuyChon(qlsv, lvSinhVien, "search");
            formTuyChon.ShowDialog();
        }

        private void menuItemFont_Click_1(object sender, EventArgs e)
        {
            FontDialog fontDialog = fontDialog1;
            var isOK = fontDialog.ShowDialog();
        ...
        private void menuItemFontColor_Click_1(object sender, EventArgs e)
        {
            ColorDialog colorDialog = new ColorDialog();
            var isOK = colorDialog.ShowDialog();
        ...
        private void menuItemDelete_Click_1(object sender, EventArgs e)
        {
            btnXoa.PerformClick();
        }

        private void menuItemEdit_Click_1(object sender, EventArgs e)
        {
            btnSua.PerformClick();
        }
